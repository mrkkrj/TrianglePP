...
// 
// Extracted from the original Triangle code -> see the *void info()* function.
//
//  - describes the non-library version (i.e. single executable) of Triangle,
//    but also offers some interesting background and troubleshooting info!
//
